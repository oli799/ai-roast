...
<div class="max-w-screen-xl mx-auto px-5 space-y-20">
    ...
    <div x-data="{phone: false}">
        <div class="max-h-[450px] overflow-y-auto shadow-lg rounded-xl relative mx-auto" :class="phone ? 'w-72' : 'w-full'">
            <label class="swap swap-rotate absolute btn btn-square btn-primary top-5 right-5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="swap-on w-6 h-6">
    ...
    <section class="flex flex-col space-y-10">
            ...
            <div class="flex flex-col space-y-4">
                <div>
                    ...
                    <p class="md:text-lg opacity-90"><span class="font-bold">Advice:</span> {!!nl2br($topic['advice'])!!}</p>
                </div>
