...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kalam:wght@300;400;700&family=Oswald:wght@300;400;500;700&display=swap" rel="stylesheet">
...
<body>
    <header class="w-full my-4 px-4 md:pt-4">
        <div class="navbar justify-between bg-base-200 text-base-content rounded-box w-full max-w-xl mx-auto">
            <div class="flex-none">
                <a href="{{route('home')}}"
                    class="normal-case font-bold text-lg btn btn-ghost tracking-tight">{{config('app.name')}}</a>
            </div>
